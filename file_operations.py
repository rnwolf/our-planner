...
class FileOperations:
    ...
    def new_project(self):
        ...
        if messagebox.askyesno("New Project", "Are you sure you want to create a new project? All unsaved changes will be lost."):
            self.manager.tasks = []
    ...
    def open_file(self):
        ...
        try:
            ...
            if "tasks" not in data or "resources" not in data or "days" not in data:
                messagebox.showerror("Invalid File", "The selected file is not a valid project file.")
                return
            ...
            self.manager.root.title(f"Task Resource Manager - {os.path.basename(file_path)}")
            ...
            messagebox.showinfo("Project Loaded", f"Project loaded from {os.path.basename(file_path)}")
    ...
    def save_to_file(self, file_path):
        ...
        try:
            ...
            messagebox.showinfo("Save Successful", f"Project saved to {os.path.basename(file_path)}")
